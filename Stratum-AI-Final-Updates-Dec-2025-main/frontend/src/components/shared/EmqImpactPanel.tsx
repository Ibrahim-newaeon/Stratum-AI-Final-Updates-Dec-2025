...
export function EmqImpactPanel({
  ...
  const confidenceLabel = band === 'reliable' ? 'high' : band === 'directional' ? 'medium' : 'low';
    ...
    >
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className={cn('p-2 rounded-lg', isPositive ? 'bg-success/10' : 'bg-danger/10')}>
            <CurrencyDollarIcon
              className={cn('w-5 h-5', isPositive ? 'text-success' : 'text-danger')}
            />
          </div>
          <div>
            <h3 className="font-semibold text-white">Estimated ROAS Impact</h3>
            <p className="text-sm text-text-muted">Based on current data quality</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <div className="flex items-baseline gap-2">
              <span
                className={cn('text-4xl font-bold', isPositive ? 'text-success' : 'text-danger')}
              >
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-text-muted mt-1">Estimate has {confidenceLabel} accuracy</p>
          </div>
        </div>
