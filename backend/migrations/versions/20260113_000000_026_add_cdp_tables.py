...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        ),  # website, server, sgtm, import, crm
        sa.Column(
            "source_key", sa.String(64), nullable=False
        ...
        sa.UniqueConstraint(
            "tenant_id", "source_key", name="uq_cdp_sources_tenant_key"
        ),
    )
    ...
    op.create_table(
        ...
        # Profile data
        sa.Column(
            "profile_data", postgresql.JSONB(), server_default="{}", nullable=False
        ),
        sa.Column(
            "computed_traits", postgresql.JSONB(), server_default="{}", nullable=False
        ),
        # Lifecycle
        sa.Column(
            "lifecycle_stage", sa.String(50), server_default="anonymous", nullable=False
        ),
        ...
        sa.Column(
            "total_revenue", sa.Numeric(15, 2), server_default="0", nullable=False
        ),
        # Timestamps
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_cdp_profiles_lifecycle", "cdp_profiles", ["tenant_id", "lifecycle_stage"]
    )
    op.create_index(
        "ix_cdp_profiles_last_seen",
        "cdp_profiles",
    ...
    op.create_table(
        ...
        # Identifier details
        sa.Column(
            "identifier_type", sa.String(50), nullable=False
        ),  # email, phone, device_id, anonymous_id, external_id
        sa.Column(
            "identifier_value", sa.String(512), nullable=True
        ),  # Original value (nullable for privacy)
        sa.Column("identifier_hash", sa.String(64), nullable=False),  # SHA256 hash
        # Metadata
        sa.Column("is_primary", sa.Boolean(), server_default="false", nullable=False),
        sa.Column(
            "confidence_score", sa.Numeric(3, 2), server_default="1.00", nullable=False
        ),
        # Verification
    ...
    op.create_index(
        "ix_cdp_identifiers_tenant", "cdp_profile_identifiers", ["tenant_id"]
    )
    op.create_index(
        "ix_cdp_identifiers_profile", "cdp_profile_identifiers", ["profile_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_cdp_identifiers_hash", "cdp_profile_identifiers", ["identifier_hash"]
    )
    ...
    op.create_table(
        ...
        # Event data
        sa.Column(
            "properties", postgresql.JSONB(), server_default="{}", nullable=False
        ),
        sa.Column("context", postgresql.JSONB(), server_default="{}", nullable=False),
        sa.Column(
            "identifiers", postgresql.JSONB(), server_default="[]", nullable=False
        ),
        # Processing
        sa.Column("processed", sa.Boolean(), server_default="false", nullable=False),
        sa.Column(
            "processing_errors", postgresql.JSONB(), server_default="[]", nullable=False
        ),
    ...
    op.create_index(
        "ix_cdp_events_time", "cdp_events", ["tenant_id", sa.text("event_time DESC")]
    )
    op.create_index("ix_cdp_events_source", "cdp_events", ["source_id"])
    op.create_index(
        "ix_cdp_events_received", "cdp_events", [sa.text("received_at DESC")]
    )
    ...
    op.create_table(
        ...
        # Consent details
        sa.Column(
            "consent_type", sa.String(50), nullable=False
        ),  # analytics, ads, email, sms, all
    ...
    op.create_index(
        "ix_cdp_consents_type", "cdp_consents", ["tenant_id", "consent_type", "granted"]
    )
