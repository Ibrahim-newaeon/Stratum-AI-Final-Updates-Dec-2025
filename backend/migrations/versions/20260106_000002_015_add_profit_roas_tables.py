...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_product_catalog_tenant_sku", "product_catalog", ["tenant_id", "sku"]
    )
    op.create_index(
        "ix_product_catalog_tenant_category",
        "product_catalog",
        ["tenant_id", "category"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("product_catalog.id", ondelete="CASCADE"),
            nullable=False,
        ),
        # Effective period
    ...
    op.create_index(
        "ix_product_margins_product_date",
        "product_margins",
        ["product_id", "effective_date"],
    )
    op.create_index(
        "ix_product_margins_tenant_date",
        "product_margins",
    ...
    op.create_index(
        "ix_margin_rules_tenant_priority", "margin_rules", ["tenant_id", "priority"]
    )
    op.create_index(
        "ix_margin_rules_tenant_category", "margin_rules", ["tenant_id", "category"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "gross_revenue_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "net_revenue_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column("average_order_value_cents", sa.BigInteger(), nullable=True),
        # Cost metrics
        sa.Column(
            "total_cogs_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "product_cogs_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "shipping_costs_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "platform_fees_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "payment_fees_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        # Ad spend
        sa.Column(
            "ad_spend_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        # Profit calculations
        sa.Column(
            "gross_profit_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            "net_profit_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        # ROAS metrics
        ...
        sa.Column(
            "margin_rule_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("margin_rules.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_daily_profit_tenant_date", "daily_profit_metrics", ["tenant_id", "date"]
    )
    op.create_index(
        "ix_daily_profit_tenant_campaign",
        "daily_profit_metrics",
        ["tenant_id", "campaign_id", "date"],
    )
    op.create_index(
        "ix_daily_profit_tenant_product",
        "daily_profit_metrics",
    ...
    op.create_table(
        ...
        sa.Column(
            "total_revenue_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "total_cogs_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
            "total_ad_spend_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_profit_reports_tenant_period",
        "profit_roas_reports",
        ["tenant_id", "period_start", "period_end"],
    )
    op.create_index(
        "ix_profit_reports_tenant_type",
        "profit_roas_reports",
    ...
    op.create_index(
        "ix_cogs_uploads_tenant_date", "cogs_uploads", ["tenant_id", "uploaded_at"]
    )
