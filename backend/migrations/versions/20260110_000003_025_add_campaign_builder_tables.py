...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_tenant_platform_connection",
        "tenant_platform_connection",
        ["tenant_id", "platform"],
    )
    op.create_index(
        "ix_tenant_platform_connection_tenant_platform",
        "tenant_platform_connection",
        ["tenant_id", "platform"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "connection_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("tenant_platform_connection.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("platform", sa.String(50), nullable=False),
        ...
        sa.Column(
            "monthly_budget_cap", sa.Numeric(precision=12, scale=2), nullable=True
        ),
    ...
    op.create_unique_constraint(
        "uq_tenant_ad_account",
        "tenant_ad_account",
        ["tenant_id", "platform", "platform_account_id"],
    )
    op.create_index(
        "ix_tenant_ad_account_enabled", "tenant_ad_account", ["tenant_id", "is_enabled"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "ad_account_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("tenant_ad_account.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("platform", sa.String(50), nullable=False),
    ...
    op.create_index(
        "ix_campaign_draft_tenant_status", "campaign_draft", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_campaign_draft_platform", "campaign_draft", ["tenant_id", "platform"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "draft_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("campaign_draft.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("platform", sa.String(50), nullable=False),
        sa.Column("platform_account_id", sa.String(255), nullable=False),
    ...
    op.create_index(
        "ix_campaign_publish_log_tenant_time",
        "campaign_publish_log",
        ["tenant_id", "event_time"],
    )
    op.create_index(
        "ix_campaign_publish_log_draft", "campaign_publish_log", ["draft_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_campaign_publish_log_tenant_time", table_name="campaign_publish_log"
    )
    ...
    op.drop_index(
        "ix_tenant_platform_connection_tenant_platform",
        table_name="tenant_platform_connection",
    )
    op.drop_constraint(
        "uq_tenant_platform_connection", "tenant_platform_connection", type_="unique"
    )
