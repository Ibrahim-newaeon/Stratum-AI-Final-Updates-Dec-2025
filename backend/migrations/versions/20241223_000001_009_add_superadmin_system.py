...
def upgrade():
    ...
    op.add_column(
        "tenants",
        sa.Column(
            "mrr_cents", sa.Integer, default=0, nullable=False, server_default="0"
        ),
    )
    op.add_column(
    ...
    op.add_column(
        "tenants", sa.Column("billing_address", postgresql.JSONB, nullable=True)
    )
    op.add_column("tenants", sa.Column("vat_number", sa.String(50), nullable=True))
    op.add_column(
        "tenants",
        sa.Column("timezone", sa.String(50), default="UTC", server_default="UTC"),
    )
    op.add_column(
        "tenants",
        sa.Column("currency", sa.String(3), default="USD", server_default="USD"),
    )
    op.add_column(
        "tenants",
        sa.Column("max_connectors", sa.Integer, default=3, server_default="3"),
    )
    op.add_column(
        "tenants",
        sa.Column(
            "max_refresh_frequency_mins", sa.Integer, default=60, server_default="60"
        ),
    )
    op.add_column(
        "tenants",
    ...
    op.add_column(
        "tenants",
        sa.Column(
            "onboarding_completed", sa.Boolean, default=False, server_default="false"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(20), nullable=False, default="active"
    ...
    op.create_index(
        "ix_tenant_usage_daily_tenant_date", "tenant_usage_daily", ["tenant_id", "date"]
    )
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", sa.Integer, sa.ForeignKey("tenants.id"), nullable=False),
        sa.Column(
            "platform", sa.String(20), nullable=False
        ),  # meta/google/tiktok/snap/ga4
        sa.Column("account_id", sa.String(100), nullable=True),
        sa.Column("account_name", sa.String(255), nullable=True),
        sa.Column(
            "status", sa.String(20), default="connected"
    ...
    op.create_index(
        "ix_platform_connectors_tenant", "platform_connectors", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_system_health_hourly_timestamp", "system_health_hourly", ["timestamp"]
    )
