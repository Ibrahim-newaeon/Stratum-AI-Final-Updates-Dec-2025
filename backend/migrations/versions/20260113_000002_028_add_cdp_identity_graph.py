...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_identifier_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
        sa.Column(
            "target_identifier_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
        # Link metadata
        sa.Column(
            "link_type", sa.String(50), nullable=False, server_default="same_event"
        ),
        sa.Column(
            "confidence_score", sa.Numeric(3, 2), nullable=False, server_default="1.00"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["source_identifier_id"], ["cdp_profile_identifiers.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["target_identifier_id"], ["cdp_profile_identifiers.id"], ondelete="CASCADE"
        ),
        sa.UniqueConstraint(
            "tenant_id",
    ...
    op.create_index(
        "ix_cdp_identity_links_source", "cdp_identity_links", ["source_identifier_id"]
    )
    op.create_index(
        "ix_cdp_identity_links_target", "cdp_identity_links", ["target_identifier_id"]
    )
    op.create_index(
        "ix_cdp_identity_links_type", "cdp_identity_links", ["tenant_id", "link_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "merged_event_count", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column(
            "merged_identifier_count", sa.Integer(), server_default="0", nullable=False
        ),
        # Merge metadata
        sa.Column("merged_by_user_id", sa.Integer(), nullable=True),
        sa.Column(
            "merge_metadata", postgresql.JSONB(), server_default="{}", nullable=False
        ),
        # State
        sa.Column(
            "is_rolled_back", sa.Boolean(), server_default="false", nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["surviving_profile_id"], ["cdp_profiles.id"], ondelete="SET NULL"
        ),
    )
    ...
    op.create_index(
        "ix_cdp_profile_merges_surviving",
        "cdp_profile_merges",
        ["surviving_profile_id"],
    )
    op.create_index(
        "ix_cdp_profile_merges_merged", "cdp_profile_merges", ["merged_profile_id"]
    )
    op.create_index(
        "ix_cdp_profile_merges_time", "cdp_profile_merges", ["tenant_id", "created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "canonical_identifier_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["profile_id"], ["cdp_profiles.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["canonical_identifier_id"],
            ["cdp_profile_identifiers.id"],
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        "ix_cdp_canonical_tenant", "cdp_canonical_identities", ["tenant_id"]
    )
    op.create_index(
        "ix_cdp_canonical_profile", "cdp_canonical_identities", ["profile_id"]
    )
