...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Connection status
        sa.Column(
            "status", crm_connection_status, nullable=False, server_default="pending"
        ),
        ...
        sa.Column(
            "sync_companies", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "webhook_enabled", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        "ix_crm_connections_tenant_provider",
        "crm_connections",
        ["tenant_id", "provider"],
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["connection_id"], ["crm_connections.id"], ondelete="CASCADE"
        ),
    )

    op.create_index(
        "ix_crm_contacts_tenant_email", "crm_contacts", ["tenant_id", "email_hash"]
    )
    op.create_index(
        "ix_crm_contacts_tenant_phone", "crm_contacts", ["tenant_id", "phone_hash"]
    )
    op.create_index(
        "ix_crm_contacts_tenant_gclid", "crm_contacts", ["tenant_id", "gclid"]
    )
    op.create_index(
        "ix_crm_contacts_tenant_fbclid", "crm_contacts", ["tenant_id", "fbclid"]
    )
    op.create_index(
        "ix_crm_contacts_crm_id", "crm_contacts", ["connection_id", "crm_contact_id"]
    )
    op.create_index(
        "ix_crm_contacts_lifecycle", "crm_contacts", ["tenant_id", "lifecycle_stage"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["contact_id"], ["crm_contacts.id"], ondelete="SET NULL"
        ),
    )

    op.create_index(
        "ix_touchpoints_tenant_contact", "touchpoints", ["tenant_id", "contact_id"]
    )
    op.create_index(
        "ix_touchpoints_tenant_event_ts", "touchpoints", ["tenant_id", "event_ts"]
    )
    op.create_index(
        "ix_touchpoints_tenant_campaign", "touchpoints", ["tenant_id", "campaign_id"]
    )
    op.create_index(
        "ix_touchpoints_email_hash", "touchpoints", ["tenant_id", "email_hash"]
    )
    op.create_index(
        "ix_touchpoints_click_ids",
        "touchpoints",
        ["tenant_id", "gclid", "fbclid", "ttclid"],
    )
    op.create_index(
        "ix_touchpoints_visitor", "touchpoints", ["tenant_id", "visitor_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "attributed_touchpoint_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
        # Raw CRM data
        sa.Column("raw_properties", postgresql.JSONB(), nullable=True),
        # Timestamps
        ...
        sa.ForeignKeyConstraint(
            ["attributed_touchpoint_id"], ["touchpoints.id"], ondelete="SET NULL"
        ),
    )

    op.create_index(
        "ix_crm_deals_tenant_stage", "crm_deals", ["tenant_id", "stage_normalized"]
    )
    op.create_index("ix_crm_deals_tenant_won", "crm_deals", ["tenant_id", "is_won"])
    op.create_index(
        "ix_crm_deals_tenant_close_date", "crm_deals", ["tenant_id", "close_date"]
    )
    op.create_index(
        "ix_crm_deals_crm_id", "crm_deals", ["connection_id", "crm_deal_id"]
    )
    op.create_index(
        "ix_crm_deals_attributed_campaign",
        "crm_deals",
        ["tenant_id", "attributed_campaign_id"],
    )
    ...
    op.create_index(
        "ix_daily_pipeline_metrics_tenant_date",
        "daily_pipeline_metrics",
        ["tenant_id", "date"],
    )
    op.create_index(
        "ix_daily_pipeline_metrics_tenant_platform",
        "daily_pipeline_metrics",
