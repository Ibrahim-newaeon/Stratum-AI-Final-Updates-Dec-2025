...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "allow_comments", sa.Boolean(), nullable=False, server_default="true"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["cms_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("slug"),
    )
    ...
    op.create_table(
        ...
        sa.Column("meta_description", sa.String(length=160), nullable=True),
        sa.Column(
            "show_in_navigation", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        "ix_cms_contacts_created", "cms_contact_submissions", ["created_at"]
    )
