...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_fact_signal_health_daily_tenant_date",
        "fact_signal_health_daily",
        ["tenant_id", "date"],
    )
    op.create_index(
        "ix_fact_signal_health_daily_tenant_platform",
        "fact_signal_health_daily",
        ["tenant_id", "platform"],
    )
    op.create_index(
        "ix_fact_signal_health_daily_status",
        "fact_signal_health_daily",
        ["tenant_id", "status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "platform_conversions", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "conversion_delta_abs", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "conversion_delta_pct", sa.Float(), nullable=False, server_default="0"
        ),
        # Confidence and status
        sa.Column("confidence", sa.Float(), nullable=False, server_default="0"),
        sa.Column(
            "status",
            attribution_variance_status,
            nullable=False,
    ...
    op.create_index(
        "ix_fact_attribution_variance_daily_tenant_date",
        "fact_attribution_variance_daily",
        ["tenant_id", "date"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_fact_actions_queue_tenant_date", "fact_actions_queue", ["tenant_id", "date"]
    )
    op.create_index(
        "ix_fact_actions_queue_status", "fact_actions_queue", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_fact_actions_queue_platform",
        "fact_actions_queue",
        ["tenant_id", "platform"],
    )
