...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "segment_type", sa.String(50), server_default="dynamic", nullable=False
        ),
        ...
        sa.Column(
            "refresh_interval_hours", sa.Integer(), server_default="24", nullable=False
        ),
    ...
    op.create_index(
        "ix_cdp_segments_type", "cdp_segments", ["tenant_id", "segment_type"]
    )
    ...
    op.create_index(
        "ix_cdp_memberships_tenant", "cdp_segment_memberships", ["tenant_id"]
    )
    op.create_index(
        "ix_cdp_memberships_segment", "cdp_segment_memberships", ["segment_id"]
    )
    op.create_index(
        "ix_cdp_memberships_profile", "cdp_segment_memberships", ["profile_id"]
    )
    op.create_index(
        "ix_cdp_memberships_active",
        "cdp_segment_memberships",
    ...
    op.create_table(
        ...
        sa.Column(
            "source_config", postgresql.JSONB(), server_default="{}", nullable=False
        ),
        # Output configuration
        sa.Column(
            "output_type", sa.String(50), server_default="number", nullable=False
        ),
    ...
    op.create_index(
        "ix_cdp_traits_active", "cdp_computed_traits", ["tenant_id", "is_active"]
    )
