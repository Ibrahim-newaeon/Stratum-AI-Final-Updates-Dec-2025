...
def upgrade() -> None:
    ...
    report_format = postgresql.ENUM(
        "pdf", "csv", "excel", "json", "html", name="report_format", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            server_default=sa.text("'{pdf,csv}'"),
        ),
        # Styling
        ...
        sa.ForeignKeyConstraint(
            ["last_modified_by_user_id"], ["users.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_report_template_type", "report_templates", ["tenant_id", "report_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "timezone", sa.String(50), nullable=False, server_default=sa.text("'UTC'")
        ),
        # Schedule timing
        ...
        sa.Column(
            "delivery_config", postgresql.JSONB(), nullable=False, server_default="{}"
        ),
        # Execution tracking
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["template_id"], ["report_templates.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["created_by_user_id"], ["users.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "ix_scheduled_report_template", "scheduled_reports", ["template_id"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["template_id"], ["report_templates.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["schedule_id"], ["scheduled_reports.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "ix_report_execution_tenant", "report_executions", ["tenant_id", "started_at"]
    )
    op.create_index(
        "ix_report_execution_status", "report_executions", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_report_execution_schedule", "report_executions", ["schedule_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["execution_id"], ["report_executions.id"], ondelete="CASCADE"
        ),
    )

    op.create_index(
        "ix_report_delivery_execution", "report_deliveries", ["execution_id"]
    )
    op.create_index(
        "ix_report_delivery_status", "report_deliveries", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_report_delivery_channel", "report_deliveries", ["tenant_id", "channel"]
    )
    ...
    op.create_index(
        "ix_delivery_config_tenant", "delivery_channel_configs", ["tenant_id"]
    )
