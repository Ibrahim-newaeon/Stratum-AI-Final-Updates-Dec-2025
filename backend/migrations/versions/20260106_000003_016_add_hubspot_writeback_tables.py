...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # What to sync
        sa.Column(
            "sync_attribution", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "sync_profit_metrics", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "sync_touchpoint_count", sa.Boolean(), nullable=False, server_default="true"
        ),
        # Property setup status
        sa.Column(
            "properties_created", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        "ix_writeback_config_tenant", "crm_writeback_configs", ["tenant_id"]
    )
    op.create_index(
        "ix_writeback_config_next_sync",
        "crm_writeback_configs",
        ["next_sync_at"],
    ...
    op.create_index(
        "ix_writeback_sync_tenant_date",
        "crm_writeback_syncs",
        ["tenant_id", "started_at"],
    )
    op.create_index(
        "ix_writeback_sync_status", "crm_writeback_syncs", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_writeback_sync_connection",
        "crm_writeback_syncs",
