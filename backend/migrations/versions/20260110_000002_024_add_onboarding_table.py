...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            server_default="business_profile",
        ),
        sa.Column(
            "completed_steps",
        ...
        sa.Column(
            "target_markets", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        # Step 2: Platform Selection
        sa.Column(
            "selected_platforms", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        # Step 3: Goals Setup
        ...
        sa.Column(
            "auto_pause_enabled", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "auto_scale_enabled", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "notification_email", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "notification_slack", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
        ...
        sa.Column(
            "trust_threshold_alert", sa.Integer(), nullable=False, server_default="40"
        ),
        sa.Column("require_approval_above", sa.Integer(), nullable=True),
        sa.Column(
            "max_daily_actions", sa.Integer(), nullable=False, server_default="10"
        ),
    ...
    # Create indexes
    op.create_index(
        "ix_tenant_onboarding_tenant_id", "tenant_onboarding", ["tenant_id"]
    )
