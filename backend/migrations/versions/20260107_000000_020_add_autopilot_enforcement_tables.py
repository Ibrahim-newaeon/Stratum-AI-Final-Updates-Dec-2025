...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "enforcement_enabled", sa.Boolean(), server_default="true", nullable=False
        ),
        sa.Column(
            "default_mode", sa.String(20), server_default="advisory", nullable=False
        ),
        # Budget thresholds
        ...
        # ROAS thresholds
        sa.Column(
            "min_roas_threshold", sa.Float(), server_default="1.0", nullable=False
        ),
        sa.Column(
            "roas_lookback_days", sa.Integer(), server_default="7", nullable=False
        ),
        # Frequency settings
        sa.Column(
        ...
        sa.Column(
            "custom_rules", postgresql.JSONB(), server_default="[]", nullable=False
        ),
        # Notification settings
        sa.Column(
            "notify_on_block", sa.Boolean(), server_default="true", nullable=False
        ),
        sa.Column(
            "notify_on_override", sa.Boolean(), server_default="true", nullable=False
        ),
        sa.Column(
