...
def upgrade():
    ...
    op.create_index(
        "ix_cost_allocation_daily_tenant_date",
        "fact_cost_allocation_daily",
        ["tenant_id", "date"],
    )
    op.create_index(
        "ix_cost_allocation_daily_date", "fact_cost_allocation_daily", ["date"]
    )
    ...
    op.create_index(
        "ix_platform_rate_limits_tenant",
        "platform_rate_limits",
        ["tenant_id", "platform"],
    )
    ...
    op.create_index(
        "ix_feature_usage_tenant_date", "feature_usage", ["tenant_id", "date"]
    )
