...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "first_touch_count", sa.Integer(), server_default="0", nullable=False
        ),
    ...
    op.create_index(
        "ix_daily_attributed_rev_tenant_date",
        "daily_attributed_revenue",
        ["tenant_id", "date"],
    )
    op.create_index(
        "ix_daily_attributed_rev_model",
        "daily_attributed_revenue",
        ["tenant_id", "attribution_model", "date"],
    )
    op.create_index(
        "ix_daily_attributed_rev_dimension",
        "daily_attributed_revenue",
        ["tenant_id", "dimension_type", "dimension_id", "date"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "avg_deal_size_cents", sa.BigInteger(), server_default="0", nullable=False
        ),
        # Time metrics
    ...
    op.create_index(
        "ix_conversion_paths_hash", "conversion_paths", ["tenant_id", "path_hash"]
    )
    op.create_index(
        "ix_conversion_paths_conversions",
        "conversion_paths",
        ["tenant_id", "conversions"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_touchpoints", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column("unique_contacts", sa.Integer(), server_default="0", nullable=False),
        # Journey metrics
    ...
    op.create_index(
        "ix_attribution_snapshot_tenant_date",
        "attribution_snapshots",
    ...
    op.create_index(
        ...
        "attribution_snapshots",
        ["tenant_id", "attribution_model", "snapshot_date"],
    )
    ...
    op.create_index(
        "ix_channel_interaction_from",
        "channel_interactions",
        ["tenant_id", "from_channel"],
    )
