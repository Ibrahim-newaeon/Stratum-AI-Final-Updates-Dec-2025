...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_trained_model_tenant", "trained_attribution_models", ["tenant_id"]
    )
    op.create_index(
        "ix_trained_model_active",
        "trained_attribution_models",
        ["tenant_id", "is_active"],
    )
    op.create_index(
        "ix_trained_model_type",
        "trained_attribution_models",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["model_id"], ["trained_attribution_models.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "ix_training_run_tenant", "model_training_runs", ["tenant_id", "started_at"]
    )
    op.create_index(
        "ix_training_run_status", "model_training_runs", ["tenant_id", "status"]
    )
