...
revision = "022_landing_cms"
down_revision = "021_landing_subscribers"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "default_theme", sa.String(20), nullable=False, server_default="dark"
        ),
        sa.Column(
            "supported_languages",
            sa.String(100),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["template_id"], ["landing_page_templates.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "ix_section_page", "landing_page_sections", ["page_id", "section_key"]
    )
    op.create_index(
        "ix_section_order", "landing_page_sections", ["page_id", "display_order"]
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.ForeignKeyConstraint(
            ["section_id"], ["landing_page_sections.id"], ondelete="CASCADE"
        ),
    )
    op.create_index(
