...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "platform", "creative_id", "tenant_id", name="uq_dim_creative"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "ingestion_time", sa.DateTime(timezone=True), server_default=sa.func.now()
        ),
    )
    op.create_index(
        "ix_fact_platform_daily_date", "fact_platform_daily", ["date", "tenant_id"]
    )
    op.create_index(
        "ix_fact_platform_daily_campaign",
        "fact_platform_daily",
        ["campaign_id", "date"],
    )
    ...
    op.create_index(
        "ix_fact_creative_daily_date", "fact_creative_daily", ["date", "tenant_id"]
    )
    op.create_index(
        "ix_fact_creative_daily_creative",
        "fact_creative_daily",
        ["creative_id", "date"],
    )
    ...
    op.create_table(
        ...
        ),  # roas_alert, emq_degraded, anomaly
        sa.Column(
    ...
    op.create_index(
        "ix_fact_alerts_unresolved", "fact_alerts", ["tenant_id", "resolved"]
    )
    ...
    op.create_index(
        "ix_fact_scaling_scores_date", "fact_scaling_scores", ["date", "tenant_id"]
    )
    op.create_index(
        "ix_fact_scaling_scores_entity", "fact_scaling_scores", ["entity_id", "date"]
    )
    ...
    op.create_index(
        "ix_fact_budget_actions_date", "fact_budget_actions", ["date", "tenant_id"]
    )
