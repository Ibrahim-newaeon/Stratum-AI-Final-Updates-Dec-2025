...
class Target(Base):
    ...
    # Period
    period_type = Column(SQLEnum(TargetPeriod, name='target_period', create_constraint=False), nullable=False, default=TargetPeriod.MONTHLY)
    ...
    # Target metrics
    metric_type = Column(SQLEnum(TargetMetric, name='target_metric', create_constraint=False), nullable=False)
...
class PacingAlert(Base):
    ...
    # Alert details
    alert_type = Column(SQLEnum(AlertType, name='alert_type', create_constraint=False), nullable=False)
    severity = Column(SQLEnum(AlertSeverity, name='alert_severity', create_constraint=False), nullable=False, default=AlertSeverity.WARNING)
    status = Column(SQLEnum(AlertStatus, name='alert_status', create_constraint=False), nullable=False, default=AlertStatus.ACTIVE)
