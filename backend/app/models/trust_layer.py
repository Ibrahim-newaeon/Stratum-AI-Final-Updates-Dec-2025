...
class FactSignalHealthDaily(Base):
    ...
    # Computed status
    status = Column(SQLEnum(SignalHealthStatus, name='signal_health_status', create_type=False), nullable=False, default=SignalHealthStatus.OK)
...
class FactAttributionVarianceDaily(Base):
    ...
    status = Column(SQLEnum(AttributionVarianceStatus, name='attribution_variance_status', create_type=False), nullable=False, default=AttributionVarianceStatus.HEALTHY)
