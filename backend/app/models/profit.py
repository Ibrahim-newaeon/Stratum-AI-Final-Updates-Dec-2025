...
class ProductCatalog(Base):
    ...
    # Status
    status = Column(SQLEnum(ProductStatus, name='product_status', create_constraint=False), default=ProductStatus.ACTIVE, nullable=False)
...
class ProductMargin(Base):
    ...
    margin_type = Column(SQLEnum(MarginType, name='margin_type', create_constraint=False), default=MarginType.FIXED_AMOUNT, nullable=False)
    ...
    # Source tracking
    source = Column(SQLEnum(COGSSource, name='cogs_source', create_constraint=False), default=COGSSource.MANUAL, nullable=False)
...
class MarginRule(Base):
    ...
    margin_type = Column(SQLEnum(MarginType, name='margin_type', create_constraint=False), default=MarginType.PERCENTAGE, nullable=False)
...
class DailyProfitMetrics(Base):
    ...
    # Data quality
    cogs_source = Column(SQLEnum(COGSSource, name='cogs_source', create_constraint=False), nullable=True)
...
class COGSUpload(Base):
    ...
    source = Column(SQLEnum(COGSSource, name='cogs_source', create_constraint=False), nullable=False)
