...
class SnapchatAdapter(BaseAdapter):
    ...
    async def get_accounts(self) -> List[UnifiedAccount]:
        ...
        try:
            ...
            response = self._make_request(
                "GET",
                f"/organizations/{self.organization_id}/adaccounts"
            )
    ...
    async def get_adsets(
        ...
        try:
            ...
            for campaign in campaigns:
                ...
                response = self._make_request(
                    "GET",
                    f"/campaigns/{campaign.campaign_id}/adsquads"
                )
        ...
        try:
            ...
            for item in response.get("timeseries_stats", []):
                ...
                metrics = PerformanceMetrics(
                    ...
                    video_views=int(total_stats.get("video_views", 0)) if total_stats.get("video_views") else None,
                    video_p25=int(total_stats.get("quartile_1", 0)) if total_stats.get("quartile_1") else None,
                    video_p50=int(total_stats.get("quartile_2", 0)) if total_stats.get("quartile_2") else None,
                    video_p75=int(total_stats.get("quartile_3", 0)) if total_stats.get("quartile_3") else None,
                    video_p100=int(total_stats.get("view_completion", 0)) if total_stats.get("view_completion") else None,
                    conversions=int(total_stats.get("conversion_purchases", 0)) if total_stats.get("conversion_purchases") else None,
                    conversion_value=self._micros_to_dollars(total_stats.get("conversion_purchases_value", 0)),
    ...
    async def _create_campaign(self, action: AutomationAction) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "POST",
            f"/adaccounts/{action.account_id}/campaigns",
            data=body
        )
