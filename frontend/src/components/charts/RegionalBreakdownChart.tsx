  ...
  return (
    <div className="rounded-xl border bg-card p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <SmartTooltip
          content="Performance distribution across regions. Shows which geographic areas contribute most to your results."
          position="right"
          trigger="click"
        >
          <InfoIcon size={14} aria-label="Regional breakdown information" />
        </SmartTooltip>
      </div>
