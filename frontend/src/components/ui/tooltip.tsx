  ...
  <TooltipPrimitive.Portal>
    ...
    >
      <div className="flex items-center gap-2">
        <span>{children}</span>
        {shortcut && <TooltipShortcut keys={Array.isArray(shortcut) ? shortcut : [shortcut]} />}
      </div>
    </TooltipPrimitive.Content>
  </TooltipPrimitive.Portal>
));
  ...
  return (
    <TooltipProvider>
      <Tooltip delayDuration={delayDuration}>
        ...
        <TooltipContent side={side} align={align} variant={variant} size={size} shortcut={shortcut}>
          {content}
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
