...
export const availableWidgets: {
...
}[] = [
  {
    type: 'kpi-spend',
    title: 'Total Spend',
    description: 'Shows total ad spend',
    defaultSize: { w: 3, h: 2 },
  },
  {
    type: 'kpi-revenue',
  ...
  },
  {
    type: 'chart-spend',
    title: 'Spend Chart',
    description: 'Spend trend over time',
    defaultSize: { w: 8, h: 4 },
  },
  {
  ...
  },
  {
    type: 'simulator',
    title: 'What-If Simulator',
    description: 'Budget impact simulator',
    defaultSize: { w: 6, h: 4 },
  },
  {
    type: 'live-predictions',
    title: 'Live Predictions',
    description: 'AI-powered campaign predictions',
    defaultSize: { w: 6, h: 5 },
  },
  {
    type: 'roas-alerts',
    title: 'ROAS Alerts',
    description: 'Performance alerts and opportunities',
    defaultSize: { w: 6, h: 5 },
  },
  {
    type: 'budget-optimizer',
    title: 'Budget Optimizer',
    description: 'AI budget reallocation recommendations',
    defaultSize: { w: 6, h: 5 },
  },
];
