    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1">
          ...
          <SmartTooltip content={tooltip} position="right" trigger="click">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <SmartTooltip
                content="Simulate budget, bid, and audience changes to predict their impact on spend, revenue, and ROAS."
                position="right"
                trigger="click"
              >
                <Info className="w-3.5 h-3.5 text-muted-foreground hover:text-foreground cursor-pointer transition-colors" />
