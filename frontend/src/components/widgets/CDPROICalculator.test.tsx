...
describe('CDPROICalculator', () => {
  ...
  describe('Edge Cases', () => {
    it('handles minimum input values', () => {
      ...
      fireEvent.change(screen.getByLabelText(/Monthly Website Sessions/i), { target: { value: '10000' } })
      ...
      fireEvent.change(screen.getByLabelText(/Current Identity Match Rate/i), { target: { value: '10' } })
      fireEvent.change(screen.getByLabelText(/Expected Match Rate Improvement/i), { target: { value: '10' } })
    ...
    it('handles maximum input values', () => {
      ...
      fireEvent.change(screen.getByLabelText(/Monthly Website Sessions/i), { target: { value: '1000000' } })
      fireEvent.change(screen.getByLabelText(/Conversion Rate/i), { target: { value: '10' } })
      fireEvent.change(screen.getByLabelText(/Average Order Value/i), { target: { value: '5000' } })
      fireEvent.change(screen.getByLabelText(/Gross Margin/i), { target: { value: '80' } })
      fireEvent.change(screen.getByLabelText(/Current Identity Match Rate/i), { target: { value: '70' } })
      fireEvent.change(screen.getByLabelText(/Expected Match Rate Improvement/i), { target: { value: '60' } })
