      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-white/[0.05] border border-foreground/10 hover:bg-foreground/10 transition-colors text-sm font-medium text-white"
          >
