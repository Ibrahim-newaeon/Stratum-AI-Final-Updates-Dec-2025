        ...
        >
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative p-8 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-foreground/10 transition-colors">
                {/* Stars */}
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {platforms.map((platform) => (
              <div
                key={platform.name}
                className="flex flex-col items-center justify-center p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-foreground/10 transition-colors"
              >
