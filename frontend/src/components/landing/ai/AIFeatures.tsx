...
export default function AIFeatures() {
  ...
  return (
    <section id="features" className="relative py-32 overflow-hidden">
      {/* Background accent */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[600px] bg-gradient-to-b from-purple-500/5 to-transparent rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          {additionalFeatures.map((feature) => (
            <div
              key={feature.title}
              className="group relative p-6 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-white/10 hover:bg-white/[0.04] transition-all"
            >
              <feature.icon className="w-5 h-5 text-gray-400 group-hover:text-purple-400 transition-colors mb-3" />
