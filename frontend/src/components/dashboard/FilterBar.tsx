    ...
    <div className={cn('bg-card border rounded-lg shadow-sm', className)}>
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-t-lg">
        <button
          ...
          className="flex items-center gap-3 flex-1 hover:bg-muted/50 -ml-2 pl-2 py-1 rounded-lg transition-colors"
        >
        ...
        <div className="flex items-center gap-3 ml-4">
          ...
          {!isExpanded && activeFiltersCount > 0 && (
            <div className="hidden sm:flex items-center gap-2">
              {filters.platforms.length > 0 && filters.platforms.length < 5 && (
              ...
              {filters.regions.length > 0 && filters.regions.length < 80 && (
