...
export type TraitType = 'count' | 'sum' | 'average' | 'min' | 'max' | 'first' | 'last' | 'unique_count' | 'exists' | 'formula'
...
export const cdpApi = {
  ...
  listIdentityLinks: async (params?: {
    ...
    const response = await apiClient.get<IdentityLinksResponse>(
      '/cdp/identity-links',
      { params }
    )
    return response.data
  ...
  listSegments: async (params?: {
    ...
    const response = await apiClient.get<ApiResponse<SegmentListResponse>>(
      '/cdp/segments',
      { params }
    )
    return response.data.data
  ...
  getSegment: async (segmentId: string): Promise<CDPSegment> => {
    const response = await apiClient.get<ApiResponse<CDPSegment>>(
   ...
   */
  getSegmentProfiles: async (segmentId: string, params?: {
    limit?: number
    offset?: number
   ...
   */
  deleteProfile: async (profileId: string, params?: {
  ...
  createTrait: async (trait: ComputedTraitCreate): Promise<CDPComputedTrait> => {
    const response = await apiClient.post<ApiResponse<CDPComputedTrait>>(
      '/cdp/traits',
      trait
    )
    return response.data.data
  ...
  listTraits: async (params?: {
    ...
    const response = await apiClient.get<ApiResponse<ComputedTraitListResponse>>(
      '/cdp/traits',
      { params }
    )
    return response.data.data
  ...
  getTrait: async (traitId: string): Promise<CDPComputedTrait> => {
    const response = await apiClient.get<ApiResponse<CDPComputedTrait>>(
      `/cdp/traits/${traitId}`
    )
    return response.data.data
  },
  ...
  computeAllTraits: async (): Promise<ComputeTraitsResponse> => {
    const response = await apiClient.post<ApiResponse<ComputeTraitsResponse>>(
      '/cdp/traits/compute'
    )
    return response.data.data
  },
   ...
   */
  computeProfileTraits: async (profileId: string): Promise<{ profile_id: string; computed_traits: Record<string, unknown> }> => {
    const response = await apiClient.post<ApiResponse<{ profile_id: string; computed_traits: Record<string, unknown> }>>(
  ...
  getProfileRFM: async (profileId: string, params?: RFMConfig): Promise<RFMScores> => {
    const response = await apiClient.get<ApiResponse<RFMScores>>(
      `/cdp/profiles/${profileId}/rfm`,
      { params }
    )
    return response.data.data
  },
  ...
  getRFMSummary: async (): Promise<RFMSummaryResponse> => {
    const response = await apiClient.get<ApiResponse<RFMSummaryResponse>>(
      '/cdp/rfm/summary'
    )
    return response.data.data
  },
  ...
  createFunnel: async (funnel: FunnelCreate): Promise<CDPFunnel> => {
    const response = await apiClient.post<ApiResponse<CDPFunnel>>(
      '/cdp/funnels',
      funnel
    )
    return response.data.data
  ...
  listFunnels: async (params?: {
    ...
    const response = await apiClient.get<ApiResponse<FunnelListResponse>>(
      '/cdp/funnels',
      { params }
    )
    return response.data.data
  ...
  getFunnel: async (funnelId: string): Promise<CDPFunnel> => {
    const response = await apiClient.get<ApiResponse<CDPFunnel>>(
   ...
   */
  analyzeFunnel: async (funnelId: string, params?: FunnelAnalysisRequest): Promise<FunnelAnalysisResponse> => {
  ...
  getEventTrends: async (period_days?: number): Promise<EventTrendsResponse> => {
    const response = await apiClient.get<EventTrendsResponse>(
      '/cdp/events/trends',
      { params: period_days ? { period_days } : undefined }
    )
    return response.data
  ...
  getProfileStatistics: async (): Promise<ProfileStatisticsResponse> => {
    const response = await apiClient.get<ProfileStatisticsResponse>(
      '/cdp/profiles/statistics'
    )
    return response.data
  },
  ...
  searchProfiles: async (params?: ProfileSearchParams): Promise<ProfileSearchResponse> => {
    const response = await apiClient.post<ProfileSearchResponse>(
      '/cdp/profiles/search',
      null,
      { params }
    )
  ...
  exportAudience: async (params?: AudienceExportParams): Promise<AudienceExportResponse | Blob> => {
    ...
    const response = await apiClient.post<AudienceExportResponse>(
      '/cdp/audiences/export',
      null,
      { params }
    )
    return response.data
...
export const cdpQueryKeys = {
  ...
  identityGraph: (profileId: string) => [...cdpQueryKeys.profiles(), profileId, 'identity-graph'] as const,
  canonicalIdentity: (profileId: string) => [...cdpQueryKeys.profiles(), profileId, 'canonical'] as const,
  profileMergeHistory: (profileId: string) => [...cdpQueryKeys.profiles(), profileId, 'merge-history'] as const,
  ...
  profileSegments: (profileId: string) => [...cdpQueryKeys.profiles(), profileId, 'segments'] as const,
  ...
  funnelDropOffs: (id: string, step: number) => [...cdpQueryKeys.funnels(), id, 'drop-offs', step] as const,
  profileFunnels: (profileId: string) => [...cdpQueryKeys.profiles(), profileId, 'funnels'] as const,
  profileSearch: () => [...cdpQueryKeys.profiles(), 'search'] as const,
  // Analytics
  eventStatistics: (periodDays?: number) => [...cdpQueryKeys.all, 'event-statistics', periodDays] as const,
 ...
 */
export function useSegmentProfiles(segmentId: string, params?: { limit?: number; offset?: number }, options?: { enabled?: boolean }) {
  return useQuery({
...
export function useDeleteProfile() {
  ...
  return useMutation({
    mutationFn: ({ profileId, params }: { profileId: string; params?: { delete_events?: boolean; reason?: string } }) =>
 ...
 */
export function useComputedTraits(params?: { active_only?: boolean; limit?: number; offset?: number }) {
  return useQuery({
 ...
 */
export function useProfileRFM(profileId: string, params?: RFMConfig, options?: { enabled?: boolean }) {
  return useQuery({
