      ...
      <AuthLayout>
        <div className="w-full max-w-md bg-[#0F1320] border border-[#1E2740] rounded-xl p-8 shadow-xl">
          <div className="text-left mb-8">
            <div className="w-12 h-12 rounded-lg bg-[#C9A227]/10 border border-[#C9A227]/20 flex items-center justify-center mb-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-lg bg-[#181F33] border border-[#1E2740] hover:border-[#C9A227]/40 transition-colors duration-200 group disabled:opacity-50"
            >
              <div className="w-12 h-12 rounded-lg bg-[#C9A227]/10 border border-[#C9A227]/20 flex items-center justify-center flex-shrink-0">
                <Mail className="w-6 h-6 text-[#C9A227]" />
              </div>
              <div className="text-left flex-1">
                <div className="text-sm font-semibold text-[#F0EDE5] group-hover:text-[#C9A227] transition-colors duration-200">
                  Verify via Email
                </div>
        ...
        <div className="w-full max-w-md bg-[#0F1320] border border-[#1E2740] rounded-xl p-8 shadow-xl">
          ...
          <div className="mb-6">
            <input
              ...
              className="w-full text-center text-2xl tracking-[0.5em] h-14 rounded-lg bg-[#181F33] border border-[#1E2740] text-[#F0EDE5] placeholder-[#5A6278] focus:ring-2 focus:ring-[#C9A227]/30 focus:border-[#C9A227]/50 transition-colors duration-200 outline-none font-mono"
              maxLength={6}
            />
            {otpError && (
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="text-xs text-[#C9A227] hover:text-[#D4AF37] transition-colors duration-200 disabled:opacity-40 disabled:hover:text-[#C9A227] font-medium"
              >
      ...
      <AuthLayout>
        <div className="w-full max-w-md bg-[#0F1320] border border-[#1E2740] rounded-xl p-8 shadow-xl text-center">
          ...
          <p className="text-sm text-[#8B92A8] mb-4">
            Your profile has been created and your <span className="text-[#C9A227] font-semibold">Free Tier</span> is now active.
          </p>
          ...
          <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-4 mb-6 text-left">
            ...
            <button
              ...
              className="mt-3 text-xs text-amber-500 hover:text-[#D4AF37] transition-colors duration-200 font-medium"
            >
              View Plans &rarr;
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-[#C9A227] text-[#080C14] font-semibold rounded-lg py-3 hover:bg-[#D4AF37] transition-colors duration-200 inline-flex items-center justify-center gap-2"
          >
            Sign in
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex items-start gap-3 px-1 py-1">
                <input
                  ...
                  type="checkbox"
                  id="terms"
                  className="mt-0.5 w-4 h-4 rounded border-[#1E2740] bg-[#181F33] text-[#C9A227] focus:ring-[#C9A227]/30 focus:ring-offset-0 cursor-pointer"
                />
                <label htmlFor="terms" className="text-xs text-[#8B92A8] cursor-pointer select-none">
                  I accept the{' '}
                  <a href="/terms" className="text-[#C9A227] hover:text-[#D4AF37] transition-colors duration-200 font-medium">Terms</a>
                  {' '}and{' '}
                  <a href="/privacy" className="text-[#C9A227] hover:text-[#D4AF37] transition-colors duration-200 font-medium">Privacy Policy</a>
                </label>
              </div>
              {errors.acceptTerms && (
