            ...
            <div className="w-full max-w-[448px] auth-glass-card rounded-[24px] p-7 shadow-2xl relative z-20 auth-fade-up">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="auth-fade-up-d3 w-full auth-gradient-btn auth-shimmer-btn text-[#0b1215] font-bold h-[44px] rounded-xl hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 mt-1 text-[14px] disabled:opacity-50 disabled:hover:scale-100"
                >
                  {isLoading ? (
