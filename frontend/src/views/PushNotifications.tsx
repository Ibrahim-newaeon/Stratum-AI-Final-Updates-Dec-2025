          ...
          {[
            ...
            <button
              ...
              className={cn(
                ...
                activeTab === t.id ? 'bg-primary text-primary-foreground' : 'bg-white/[0.03] text-muted-foreground hover:bg-white/[0.06]'
              )}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      ...
                      className={cn(
                        ...
                        form.sendToAll ? 'bg-primary/20 text-primary' : 'bg-white/[0.03] text-muted-foreground'
                      )}
                    >
              ...
              <button
                ...
                className="w-full bg-white/[0.03] hover:bg-white/[0.06] text-muted-foreground hover:text-foreground py-2 rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
              >
