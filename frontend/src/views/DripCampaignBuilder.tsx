...
export default function DripCampaignBuilder() {
  ...
  return (
    <div className="h-screen flex bg-[#050B18] text-white">
      ...
      <div className="w-64 border-r border-white/10 flex flex-col bg-[#0A1628]">
          ...
          {NODE_TEMPLATES.map((template) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-3 p-2.5 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/[0.12] cursor-grab active:cursor-grabbing transition-all group"
              >
        ...
        <div className="p-4 border-t border-white/10">
          ...
          <select
            ...
            className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-2 py-1.5 text-xs text-foreground"
          >
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Bar */}
        <div className="h-14 border-b border-white/10 flex items-center justify-between px-4 bg-[#0A1628]/50">
        ...
        >
          ...
          {nodes.map((node) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 bg-[#0A1628] border border-white/[0.08] hover:border-white/[0.15] rounded-xl px-3 py-2 shadow-lg shadow-black/20 min-w-[160px]">
                  ...
                  <button
                    ...
                    className="w-5 h-5 rounded-full bg-white/10 hover:bg-primary/30 flex items-center justify-center transition-colors"
      ...
      <div className="w-72 border-l border-white/10 bg-[#0A1628] flex flex-col">
        <div className="p-4 border-b border-white/10">
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary/40 resize-none"
            ...
            <>
              ...
              {selectedNodeData.type === 'condition' && (
                <>
                  ...
                  <div className="text-[10px] text-muted-foreground mt-2 p-2 bg-white/[0.02] rounded-lg">
                ...
                <>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-3 py-2 text-sm resize-none"
                    />
                  </div>
                </>
              )}
              ...
              <div className="flex gap-2 pt-3 border-t border-white/10">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 text-xs py-1.5 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] text-muted-foreground hover:text-foreground transition-colors"
                >
